...
🛠️ Data Cleaning & Transformation: The raw dataset required extensive cleaning in Excel and Python to ensure KPI accuracy:

1. Standardization: Cleaned Startup Names to remove duplicates and filled in missing names for data completeness.
2. Revenue Synchronization: Fixed discrepancies between Monthly and Annual Revenue by using a 12× multiplier to fill gaps and ensure financial consistency.
...
🐍 Python EDA Highlights: Before building the dashboard, I performed a deep dive using Python (Pandas & Seaborn):
...
👜 Tech Stack: Data Cleaning: Microsoft Excel
